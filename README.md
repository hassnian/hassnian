# Hassnian
  ...
  Frontend/fullstack engineer shipping Web3 products. Remote and Opensource
  ...
  | [KodaDot](https://github.com/kodadot/nft-gallery) | Leading Polkadot NFT marketplace. 483 PRs. Owned XCM auto-teleport (1-click cross-chain NFT buys), EVM minting, mass-minting, fiat on-ramp. | Vue 3, Nuxt, TypeScript |
  | [Chaotic](https://github.com/chaotic-art) | Current leading NFT marketplace + launchpad. 144 PRs across marketplace core and wallet flows. | Vue, Nuxt, TypeScript |
